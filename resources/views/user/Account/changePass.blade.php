                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title row py-2">
                                <div class="col-2"><a href=" {{route('user#shop')}} "><i class=" text-black fa-solid fa-arrow-left-long fa-lg"></i></a></div>
                                <h3 class="col-8 text-center title-2">Change Password</h3>
                            </div>
                            <hr>
                            <div class="px-5">
                                <form action=" {{route('user#changePassBtn')}} " method="post" novalidate="novalidate">
                                    @csrf
                                    <div class="mb-3">
