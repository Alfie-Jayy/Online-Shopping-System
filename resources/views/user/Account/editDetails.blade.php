                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title row py-2">
                            <div class="col-2"><a href=" {{route('user#accDetailsPage')}} "><i class=" text-black fa-solid fa-arrow-left-long fa-lg"></i></a></div>
                            <h3 class="col-8 text-center title-2">Edit Personal Details</h3>
                        </div>
                        <hr>

                        <form action=" {{ route('user#editConfirm') }} " method="post" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
